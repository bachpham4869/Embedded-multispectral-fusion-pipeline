# SmartBinocular — Agent Instructions

This file is the authoritative source for GitNexus code-intelligence tooling.
`CLAUDE.md` has a compact summary and points here for the full reference.
